...
/** Full experience — orbit, stats, AI (for owner preview / events) */
export function StudioGraduatePage() {
      ...
      >
        ...
        <Suspense fallback={null}>
          ...
          <SectionReveal delay={0.14}>
            <MemoryBookExport student={student} wishes={congratulations} stats={stats} />
          </SectionReveal>
        </Suspense>
      </motion.div>
